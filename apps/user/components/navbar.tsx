  ...
  return (
    <nav className="flex items-center border rounded-xl border-white justify-between px-8 py-4 bg-gradient-to-r from-blue-200 to-white shadow-md">
      ...
      <div className="space-x-4">
        <button className="px-6 py-2 text-blue-600 font-medium" onClick={() => router.push("/auth/login")}>Login</button>
        <button className="px-6 py-2 text-white bg-blue-600 font-medium" onClick={() => router.push("/auth/signup")}>Signup</button>
      </div>
    </nav>
  );
}
